      ...
      <div className="container mx-auto grid gap-10 px-4 py-14 sm:px-6 md:grid-cols-2 lg:grid-cols-4">
        <div>
          ...
          <p className="mt-4 max-w-xs text-sm leading-relaxed text-white/70">
            EASY is a modern fashion house building wearable essentials — cut
            clean, priced fair and made to last across every size and style.
          </p>
        ...
        <div>
          <h3 className="text-xl text-brandGreen">Company</h3>
        ...
        <div>
          <h3 className="text-xl text-brandGreen">Contact</h3>
        ...
        <div>
          <h3 className="text-xl text-brandGreen">Follow</h3>
          <div className="mt-4 flex flex-wrap gap-2">
            {[
              {
                icon: Facebook,
                label: "Facebook",
                link: "https://www.facebook.com/easyfashionltd.bd",
              },
              {
                icon: Instagram,
                label: "Instagram",
                link: "https://www.instagram.com/easyfashion.ltd?igshid=YmMyMTA2M2Y%3D",
              },
              {
                icon: Twitter,
                label: "X",
                link: "https://x.com/EasyFashionLtd",
              },
              {
                icon: Youtube,
                label: "YouTube",
                link: "https://www.youtube.com/channel/UCgnFMXLIClXmvibb23l1a9Q",
              },
          ...
          <p className="mt-5 text-sm text-white/70">
            ...
            <TbCurrencyTaka className="inline text-base -mt-0.5 -mr-0.5" />
            5,000. Easy 14-day exchange.
          </p>
        </div>
      </div>
