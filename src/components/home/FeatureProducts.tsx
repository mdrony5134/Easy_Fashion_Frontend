...
import { AlertCircle, ArrowRight, Layers, Ruler, Shirt } from "lucide-react";
          ...
          {SUMMARY.map(({ label, value, icon: Icon, note }) => (
            ...
            >
              ...
              <p className="mt-5 text-5xl font-bold tracking-tight">
                {isLoading ? (
                  <span className="inline-block w-16 h-12 bg-gray-200 animate-pulse rounded-lg"></span>
                ) : (
                  value
                )}
              </p>
      ...
      <section className="container mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-[minmax(0,1fr)_auto] items-end gap-4">
          <div className="min-w-0">
            ...
            <h2 className="mt-2 text-3xl font-display uppercase tracking-wider md:text-5xl">
              FRESH OFF THE RAIL
            </h2>
          </div>
        ...
        {isLoading ? (
          ...
          <div className="mt-12 text-center py-16 px-4 border-2 border-dashed border-red-500/20 rounded-xl">
