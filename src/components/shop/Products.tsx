...
export default function Products() {
  ...
  const activeCount =
    selectedCategories.length + selectedSizes.length + selectedStyles.length;
    ...
    <div className="container mx-auto px-4 py-10 sm:px-6 sm:py-14">
      <div className="grid grid-cols-[minmax(0,1fr)_auto] items-end gap-4">
        <div className="min-w-0">
          ...
          <h1 className="mt-2 text-4xl sm:text-6xl">All Products Collection</h1>
      ...
      <div className="mt-8 grid gap-8 lg:grid-cols-[260px_minmax(0,1fr)]">
        ...
        <div>
          {productsLoading ? (
            ...
            <div className="rounded-xl border-2 border-dashed border-red-500/40 p-16 text-center">
